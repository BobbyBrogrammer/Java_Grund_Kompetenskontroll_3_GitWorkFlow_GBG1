...
/**
 * AppConfig sätter ihop alla delar av applikationen.
 */
public class AppConfig {
    ...
    // Repositories för att spara data
    private final Repository<Vehicle, String> vehicleRepository = new VehicleRepository(loggingService);
    ...
    // Hantering av input/output och validering
    ...
    // Tjänster för e-post, avslut och bokningar
    ...
    private final BookingService bookingService = new BookingService(
            bookingRepository, vehicleRepository, customerRepository,
            loggingService, validationService, priceService, completionService);

    // Olika bokningsfunktioner (visa, söka, ta bort, uppdatera)
    ...
    // Användargränssnitt och menyer
    private final ConsoleUI ui = new ConsoleUI(IO, input, output, completionService,
            vehicleFactory, bookingFactory, customerFactory,
            vehicleRepository, customerRepository, bookingRepository,
            searchAction, deleteAction, updateBooking, priceService, bookingService, showAllBookings);
    ...
    // Initiering av grunddata
    private final InitializationService initializationService = new InitializationService(
            customerRepository, vehicleRepository, bookingRepository,
            customerFactory, vehicleFactory, bookingFactory);

    // Getter för initialiseringstjänsten
