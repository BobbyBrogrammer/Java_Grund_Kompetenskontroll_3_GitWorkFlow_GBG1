...
public class OutputHandler {
    private final IIO io; // Interface för in- och utdata (konsol)
    ...
    public void printStateCustomerName() { io.printLine("Ange kundens namn: "); }
    public void printStateCustomerEmail() { io.printLine("Ange kundens e-postadress: "); }
    public void printStateCustomerPhoneNumber() { io.printLine("Ange kundens telefonnummer: "); }

    // Prompts för bilinformation
    public void printStateCarRegNumber() { io.printLine("Ange registreringsnummer, t.ex (ABC123)"); }
    public void printStateCarModel() { io.printLine("Ange bilmärke och modell, t.ex (Volvo S60)"); }
    public void printStateYearModel() { io.printLine("Ange årsmodell, t.ex (2009)"); }

    // Bekräftelsemeddelanden
    public void printBookingSuccess() { io.printLine("Korrekt bokad och inläst i systemet!"); }
    public void printError(String message) { io.printLine("Fel: " + message); }
    public void printSuccess(String message) { io.printLine("Kanon! " + message); }

    //------------------------------------------------------------------
    //---------------------- Alla bokningar ----------------------------
    public void printShowAllBookingsTitle() { io.printLine("\n\u001B[34m====  Alla bokningar  ====\u001B[0m"); }
    public void printIfNoBookings() { io.printLine("Inga bokningar registrerade ännu."); }
    ...
    //------------------------------------------------------------------
    //---------------------- Ta bort bokning --------------------------
    public void printRemoveBooking() { io.printLine("\n\u001B[31m==== Ta bort bokning  ====\u001B[0m"); }
    public void printBookingWasRemoved() { io.printLine("Bokningen togs bort."); }
    public void printNoBookingFoundToRemove() { io.printLine("Ingen bokning hittades att ta bort."); }
    ...
    public void printBookingHaveBeenUpdated(Booking booking) {
        // Visar uppdaterad bokning
        io.printLine("Bokningen har uppdaterats.");
        io.printLine(booking.toString());
    }
    public void printNoBookingFoundToUpdate() { io.printLine("Ingen bokning hittades att uppdatera."); }
    ...
    public void printExitProgram() { io.printLine("Avslutar programmet...Hejdå!"); }
    public void printDefaultMenuChoice() { io.printLine("Ogiltigt val, försök igen!"); }

    //------------------------------------------------------------------
    //------------------- InputHandler meddelanden --------------------
    ...
    // Specifika menyer för bokningsval
